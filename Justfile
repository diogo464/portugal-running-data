...
scrape:
    ./fetch-sitemap
    ./setup-directories
    ./list-slugs | xargs -L 64 -P 4 ./fetch-page
    ./list-slugs | xargs -L 64 -P 0 ./extract-id
    ./list-slugs | xargs -L 64 -P 8 ./fetch-ics
    ./list-slugs | xargs -L 64 -P 8 ./fetch-data
    ./list-slugs | xargs -L 64 -P 8 ./fetch-image
    ./list-slugs | xargs -L 64 -P 4 ./fetch-location
    ./list-slugs | xargs -L 64 -P 4 ./fetch-oneline-description
